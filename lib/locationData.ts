...
export interface Country {
  ...
  export const COUNTRIES: Country[] = [
    ...
    { code: 'BG', name: 'Bulgaria', flag: '🇧🇬', majorCities: ['Sofia', 'Plovdiv', 'Varna', 'Burgas', 'Ruse'] },
    { code: 'HR', name: 'Croatia', flag: '🇭🇷', majorCities: ['Zagreb', 'Split', 'Rijeka', 'Osijek', 'Zadar'] },
    { code: 'CY', name: 'Cyprus', flag: '🇨🇾', majorCities: ['Nicosia', 'Limassol', 'Larnaca', 'Paphos'] },
    { code: 'CZ', name: 'Czech Republic', flag: '🇨🇿', majorCities: ['Prague', 'Brno', 'Ostrava', 'Plzeň', 'Liberec', 'Olomouc', 'Ústí nad Labem'] },
    ...
    { code: 'HU', name: 'Hungary', flag: '🇭🇺', majorCities: ['Budapest', 'Debrecen', 'Szeged', 'Miskolc', 'Pécs', 'Győr'] },
    ...
    { code: 'MD', name: 'Moldova', flag: '🇲🇩', majorCities: ['Chișinău', 'Tiraspol', 'Bălți'] },
    { code: 'ME', name: 'Montenegro', flag: '🇲🇪', majorCities: ['Podgorica', 'Nikšić', 'Herceg Novi', 'Bar'] },
    ...
    { code: 'MK', name: 'North Macedonia', flag: '🇲🇰', majorCities: ['Skopje', 'Bitola', 'Kumanovo', 'Tetovo', 'Ohrid'] },
    { code: 'NO', name: 'Norway', flag: '🇳🇴', majorCities: ['Oslo', 'Bergen', 'Trondheim', 'Stavanger', 'Drammen', 'Fredrikstad', 'Kristiansand', 'Tromsø'] },
    { code: 'PL', name: 'Poland', flag: '🇵🇱', majorCities: ['Warsaw', 'Kraków', 'Łódź', 'Wrocław', 'Poznań', 'Gdańsk', 'Szczecin', 'Bydgoszcz', 'Lublin', 'Katowice'] },
    { code: 'PT', name: 'Portugal', flag: '🇵🇹', majorCities: ['Lisbon', 'Porto', 'Braga', 'Coimbra', 'Faro'] },
    { code: 'RO', name: 'Romania', flag: '🇷🇴', majorCities: ['Bucharest', 'Cluj-Napoca', 'Timișoara', 'Iași', 'Constanța', 'Craiova', 'Brașov'] },
    { code: 'RS', name: 'Serbia', flag: '🇷🇸', majorCities: ['Belgrade', 'Novi Sad', 'Niš', 'Kragujevac', 'Subotica'] },
    { code: 'SK', name: 'Slovakia', flag: '🇸🇰', majorCities: ['Bratislava', 'Košice', 'Prešov', 'Žilina', 'Nitra'] },
    ...
    { code: 'UA', name: 'Ukraine', flag: '🇺🇦', majorCities: ['Kyiv', 'Kharkiv', 'Odesa', 'Dnipro', 'Lviv', 'Zaporizhzhia'] },
  ...
  export const ETHNICITIES: Ethnicity[] = [
    ...
    { name: 'Maldivian', flag: '🇲🇻', description: 'Maldivian' },
    {
    ...
    // African
    {
      ...
      subEthnicities: ['Nigerian', 'Senegalese', 'Malian', 'Ghanaian', 'Gambian', 'Ivorian', 'Sierra Leonean', 'Nigerien', 'Chadian', 'Guinean', 'Burkinabe'],
    },
    {
      name: 'East African', flag: '🇰🇪', description: 'Somali, Ethiopian, Eritrean, Kenyan, Tanzanian, Ugandan',
      subEthnicities: ['Somali', 'Ethiopian', 'Eritrean', 'Kenyan', 'Tanzanian', 'Ugandan', 'Djiboutian'],
    },
    ...
    { name: 'Cameroonian', flag: '🇨🇲', description: 'Cameroonian' },
    { name: 'Mozambican', flag: '🇲🇿', description: 'Mozambican' },
    ...
    { name: 'Black British', flag: '🇬🇧', description: 'Black British' },
    { name: 'White - American', flag: '🇺🇸', description: 'American (Caucasian)' },
    { name: 'Italian', flag: '🇮🇹', description: 'Italian' },
    { name: 'Greek', flag: '🇬🇷', description: 'Greek' },
    { name: 'Spanish', flag: '🇪🇸', description: 'Spanish' },
    { name: 'Belgian', flag: '🇧🇪', description: 'Belgian' },
    { name: 'Austrian', flag: '🇦🇹', description: 'Austrian' },
    { name: 'Swiss', flag: '🇨🇭', description: 'Swiss' },
    { name: 'Finnish', flag: '🇫🇮', description: 'Finnish' },
    {
      name: 'White - European', flag: '🇪🇺', description: 'French, German, Dutch, Scandinavian, Eastern European',
      subEthnicities: ['French', 'German', 'Dutch', 'Scandinavian', 'Eastern European', 'Polish', 'Czech', 'Hungarian', 'Romanian', 'Ukrainian', 'Bulgarian', 'Slovak', 'Moldovan', 'Portuguese', 'Cypriot'],
    },
    {
      name: 'White - Balkan', flag: '🇦🇱', description: 'Albanian, Bosnian, Kosovar, Croatian, Serbian, Macedonian, Montenegrin',
      subEthnicities: ['Albanian', 'Bosnian', 'Kosovar', 'Croatian', 'Serbian', 'Macedonian', 'Montenegrin'],
    },

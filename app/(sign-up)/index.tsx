...
export default function GenderSelectionScreen() {
  ...
  const handleBrotherApply = () => {
    router.push('/(sign-up)/brother');
  };

  const handleSisterApply = () => {
    router.push('/(sign-up)/sister');
  };
    ...
    <View style={styles.container}>
      <SafeAreaView style={styles.safeArea} edges={['top', 'bottom']}>
        <View style={styles.content}>
          ...
          <Text style={styles.subtitle}>Choose an account type</Text>
          ...
          <View style={styles.infoBox}>
            ...
            <View style={styles.infoTextContainer}>
              ...
              <Text style={styles.infoText}>
                After signing up, complete your profile and get verified by your local imam to maintain our high community standards.
              </Text>
            </View>
          </View>
